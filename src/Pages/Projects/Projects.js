        ...
        <Container className="B-cont Projects-container">
            ...
            <Row className="Projects-content">
                <Col md={6} sm={12} className="Projects-box">
                    <a href="https://github.com/Bearly-Codes/SunriseOS" target="_blank" style={{ textDecoration: 'none', display: 'inline-block' }}>
                        <img src={SunriseOS} alt="Sunrise OS" />
                    </a>
                    ...
                    <Row className="Projects-proj-content">
                        An OS built with the help of OSDev.org resources, currently has functional interrupts and printing capabilities. In progress.
                    </Row>
